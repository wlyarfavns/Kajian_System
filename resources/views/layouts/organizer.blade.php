        ...
        <div class="relative z-10 flex flex-col h-full">
            ...
            <nav class="flex-1 overflow-y-auto py-6 space-y-3" :class="(isMobile || expanded) ? 'px-4' : 'px-2'">
                <a href="{{ url('/organizer') }}" class="flex items-center py-3.5 text-sm font-medium transition-all duration-200 rounded-xl {{ request()->is('organizer') ? 'bg-white/15 text-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/10 ring-1 ring-white/5' : 'text-[#B7C9BE] hover:text-white hover:bg-white/10 hover:shadow-lg' }}" :class="(isMobile || expanded) ? 'px-4 justify-start' : 'px-0 justify-center'">
                    <i data-lucide="layout-dashboard" class="w-5 h-5 shrink-0 {{ request()->is('organizer') ? 'text-[#E7C77E]' : '' }}" :class="(isMobile || expanded) ? 'mr-3' : 'mr-0'"></i> 
                ...
                <a href="{{ route('organizer.kajian.index') }}" class="flex items-center py-3.5 text-sm font-medium transition-all duration-200 rounded-xl {{ request()->routeIs('organizer.kajian.*') ? 'bg-white/15 text-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/10 ring-1 ring-white/5' : 'text-[#B7C9BE] hover:text-white hover:bg-white/10 hover:shadow-lg' }}" :class="(isMobile || expanded) ? 'px-4 justify-start' : 'px-0 justify-center'">
                    <i data-lucide="calendar-check" class="w-5 h-5 shrink-0 {{ request()->routeIs('organizer.kajian.*') ? 'text-[#E7C77E]' : '' }}" :class="(isMobile || expanded) ? 'mr-3' : 'mr-0'"></i> 
                ...
                <a href="{{ route('organizer.mosque.index') }}" class="flex items-center py-3.5 text-sm font-medium transition-all duration-200 rounded-xl {{ request()->routeIs('organizer.mosque.*') ? 'bg-white/15 text-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/10 ring-1 ring-white/5' : 'text-[#B7C9BE] hover:text-white hover:bg-white/10 hover:shadow-lg' }}" :class="(isMobile || expanded) ? 'px-4 justify-start' : 'px-0 justify-center'">
                    <i data-lucide="map-pin" class="w-5 h-5 shrink-0 {{ request()->routeIs('organizer.mosque.*') ? 'text-[#E7C77E]' : '' }}" :class="(isMobile || expanded) ? 'mr-3' : 'mr-0'"></i> 
                    <span x-show="isMobile || expanded" class="whitespace-nowrap">Data Masjid</span>
                </a>
                ...
                <a href="{{ route('organizer.peserta.global') }}" class="flex items-center py-3.5 text-sm font-medium transition-all duration-200 rounded-xl {{ request()->routeIs('organizer.peserta.*') ? 'bg-white/15 text-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/10 ring-1 ring-white/5' : 'text-[#B7C9BE] hover:text-white hover:bg-white/10 hover:shadow-lg' }}" :class="(isMobile || expanded) ? 'px-4 justify-start' : 'px-0 justify-center'">
                    <i data-lucide="users" class="w-5 h-5 shrink-0 {{ request()->routeIs('organizer.peserta.*') ? 'text-[#E7C77E]' : '' }}" :class="(isMobile || expanded) ? 'mr-3' : 'mr-0'"></i> 
                    <span x-show="isMobile || expanded" class="whitespace-nowrap">Daftar Peserta</span>
                </a>
                ...
                <a href="{{ route('organizer.profile.edit') }}" class="flex items-center py-3.5 text-sm font-medium transition-all duration-200 rounded-xl {{ request()->routeIs('organizer.profile.*') ? 'bg-white/15 text-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/10 ring-1 ring-white/5' : 'text-[#B7C9BE] hover:text-white hover:bg-white/10 hover:shadow-lg' }}" :class="(isMobile || expanded) ? 'px-4 justify-start' : 'px-0 justify-center'">
                    <i data-lucide="user" class="w-5 h-5 shrink-0 {{ request()->routeIs('organizer.profile.*') ? 'text-[#E7C77E]' : '' }}" :class="(isMobile || expanded) ? 'mr-3' : 'mr-0'"></i> 
                    <span x-show="isMobile || expanded" class="whitespace-nowrap">Profil Penyelenggara</span>
                </a>
            </nav>

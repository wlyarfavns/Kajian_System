            ...
            <form method="POST" action="{{ route('password.store') }}" style="display:flex; flex-direction:column; gap:16px;">
                ...
                <div>
                    ...
                    <div style="position:relative;">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus class="login-input">
                    </div>
                ...
                <div>
                    ...
                    <div style="position:relative;">
                        ...
                        <input id="password" type="password" name="password" required autocomplete="new-password" class="login-input">
                    </div>
                ...
                <div>
                    ...
                    <div style="position:relative;">
                        ...
                        <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" class="login-input">
                    </div>
                    <x-input-error :messages="$errors->get('password_confirmation')" style="margin-top:6px; color:#dc2626; font-size:12px;" />
                </div>

                <button type="submit" class="btn-solid" style="margin-top: 8px;">Atur Ulang Sandi</button>

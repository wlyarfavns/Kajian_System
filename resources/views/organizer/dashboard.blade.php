                ...
                <table class="w-full text-left" x-show="activeTab === 'pendaftar'" style="display: none;" x-transition>
                    ...
                    <tbody class="divide-y divide-gray-50 text-sm">
                        <template x-for="attendee in lists.recentAttendees" :key="attendee.user_name + attendee.kajian_title">
                            <tr>
                                <td class="py-4 text-gray-900 font-bold" x-text="attendee.user_name"></td>
                                <td class="py-4 text-gray-600 font-medium truncate max-w-[200px]" x-text="attendee.kajian_title"></td>
                                <td class="py-4 text-gray-600 font-medium" x-text="attendee.created_at"></td>
                                <td class="py-4 flex justify-end">
                ...
                <table class="w-full text-left" x-show="activeTab === 'lokasi'" style="display: none;" x-transition>
                    <thead>
                        <tr class="text-xs font-bold text-gray-400 border-b border-gray-100 uppercase tracking-wider">
                            ...
                            <th class="pb-3 font-medium text-right">Fasilitas</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50 text-sm">
                        <template x-for="mosque in lists.recentMosques" :key="mosque.name">
                            <tr>
                                ...
                                <td class="py-4 text-gray-600 font-medium truncate max-w-[300px]" x-text="mosque.address"></td>

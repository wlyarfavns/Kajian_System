    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
        <div class="p-6 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center">
            ...
            <div class="mt-4 sm:mt-0 flex flex-col sm:flex-row gap-3 items-center w-full sm:w-auto">
                <form action="{{ route('organizer.kajian.peserta', $kajian->id) }}" method="GET" class="relative w-full sm:w-64" data-turbo="false">
                ...
                <a href="{{ route('organizer.kajian.peserta.export', $kajian->id) }}" data-turbo="false" class="inline-flex items-center justify-center px-4 py-2 w-full sm:w-auto bg-white border border-gray-300 text-sm font-medium rounded-lg text-brand-ink hover:bg-gray-50 transition shrink-0">
